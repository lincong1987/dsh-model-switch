/**
 * Browser client bundle for dsh-model-switch (DeepSeek Harness clientBundle protocol).
 */
...
const config: UserConfig = {
  ...
  plugins: [{
    ...
    resolveId(source: string) {
      ...
      throw new Error(
        `client bundle purity: "${source}" is not allowed — collaborate through cordis services`,
      )
    },
  }, {
