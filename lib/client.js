	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			loadError: "无法加载模型列表",
			saveError: "保存失败",
			unavailable: "设置暂不可用。请使用 DSH 0.1.0-rc.8 或更高版本。",
			planHeader: "计划待审",
			planDiscuss: "去聊天里说",
			planDecline: "拒绝",
			planApprove: "确认执行",
		...
		const en = {
			...
			unavailable: "Settings are unavailable. Requires DSH 0.1.0-rc.8 or later.",
		...
		*
		* DSH 0.1.0-rc.8 serves plugin-registered namespaces through settings.*;
