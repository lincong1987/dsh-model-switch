	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			loadError: "无法加载模型列表",
			saveError: "保存失败",
			unavailable: "设置暂不可用。请使用 DSH 0.1.2-alpha.4 或更高版本。",
			planHeader: "计划待审",
			planDiscuss: "去聊天里说",
			planDecline: "拒绝",
			planApprove: "确认执行",
		...
		const en = {
			...
			unavailable: "Settings are unavailable. Requires DSH 0.1.2-alpha.4 or later.",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\projects\dsh-model-switch\src\client\ModelPicker.module.css.mjs
		const css$3 = ".FiMpfW_root{min-width:0;position:relative}.FiMpfW_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.FiMpfW_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.FiMpfW_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.FiMpfW_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.FiMpfW_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.FiMpfW_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.FiMpfW_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.FiMpfW_chevronOpen{transform:rotate(180deg)}.FiMpfW_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;overflow:hidden}.FiMpfW_menuTop{bottom:calc(100% + 8px);right:0}.FiMpfW_menuBottom{top:calc(100% + 8px);left:0}.FiMpfW_status,.FiMpfW_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.FiMpfW_error{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.FiMpfW_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.FiMpfW_groups{min-height:0;overflow-y:auto}.FiMpfW_group+.FiMpfW_group{margin-top:4px}.FiMpfW_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.FiMpfW_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.FiMpfW_option:hover:not(:disabled),.FiMpfW_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.FiMpfW_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.FiMpfW_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.FiMpfW_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.FiMpfW_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.FiMpfW_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.FiMpfW_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.FiMpfW_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.FiMpfW_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.FiMpfW_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.FiMpfW_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}.FiMpfW_muted{color:var(--dsw-alias-label-tertiary,#666);margin:0;font-size:.8rem}";
		...
		var ModelPicker_module_css_default = {
			"cell": "FiMpfW_cell",
			"cellChevron": "FiMpfW_cellChevron",
			"cellLabel": "FiMpfW_cellLabel",
			"cellValue": "FiMpfW_cellValue",
			"check": "FiMpfW_check",
			"chevron": "FiMpfW_chevron",
			"chevronOpen": "FiMpfW_chevronOpen",
			"description": "FiMpfW_description",
			"empty": "FiMpfW_empty",
			"error": "FiMpfW_error",
			"group": "FiMpfW_group",
			"groupTitle": "FiMpfW_groupTitle",
			"groups": "FiMpfW_groups",
			"menu": "FiMpfW_menu",
			"menuBottom": "FiMpfW_menuBottom",
			"menuTop": "FiMpfW_menuTop",
			"modelName": "FiMpfW_modelName",
			"muted": "FiMpfW_muted",
			"option": "FiMpfW_option",
			"optionCopy": "FiMpfW_optionCopy",
			"retry": "FiMpfW_retry",
			"root": "FiMpfW_root",
			"status": "FiMpfW_status",
			"trigger": "FiMpfW_trigger",
			"triggerEffort": "FiMpfW_triggerEffort",
			"triggerLabel": "FiMpfW_triggerLabel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\projects\dsh-model-switch\src\client\styles.module.css.mjs
		const css$2 = ".p6Z8Ea_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;padding:.25rem 0 1.5rem;display:flex}.p6Z8Ea_titleRow{align-items:center;gap:8px;display:flex}.p6Z8Ea_titleIcon{color:var(--dsw-alias-label-secondary);flex:none}.p6Z8Ea_title{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:500;line-height:24px}.p6Z8Ea_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:14px;line-height:22px}.p6Z8Ea_block{border-top:1px solid var(--dsw-alias-border-l2,#00000014);flex-direction:column;gap:10px;padding:12px 0 0;display:flex}.p6Z8Ea_blockTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;font-weight:500;line-height:22px}.p6Z8Ea_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}.p6Z8Ea_modes{background:var(--dsw-alias-interactive-bg-hover,#0000000a);border-radius:18px;flex-wrap:wrap;gap:4px;padding:3px;display:inline-flex}.p6Z8Ea_mode{appearance:none;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:14px;outline:none;padding:0 12px;font-size:13px;font-weight:500;line-height:20px}.p6Z8Ea_mode:hover:not(:disabled):not(.p6Z8Ea_modeActive){color:var(--dsw-alias-label-primary)}.p6Z8Ea_mode:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.p6Z8Ea_mode:disabled{opacity:.55;cursor:default}.p6Z8Ea_modeActive{background:var(--dsw-specific-menu,#fff);color:var(--dsw-alias-label-primary);box-shadow:0 0 0 1px var(--dsw-alias-border-l2,#00000014)}.p6Z8Ea_pickerWrap{margin-top:2px}.p6Z8Ea_error{color:var(--dsw-alias-state-error-primary,#c0392b);margin:0;font-size:12px;line-height:18px}.p6Z8Ea_frame{width:100%}.p6Z8Ea_card{border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-specific-menu,#fff);border-radius:12px;overflow:hidden}.p6Z8Ea_strip{color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-info-primary,#3b82f6) 12%, transparent);align-items:center;gap:.45rem;padding:.65rem .9rem;font-size:.8rem;font-weight:600;display:flex}.p6Z8Ea_dot{background:var(--dsw-alias-state-info-primary,#3b82f6);border-radius:50%;width:.45rem;height:.45rem}.p6Z8Ea_body{max-height:min(42vh,28rem);padding:.85rem 1rem;overflow:auto}.p6Z8Ea_footer{border-top:1px solid var(--dsw-alias-border-l2,#00000014);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:.65rem;padding:.7rem .9rem;display:flex}.p6Z8Ea_feedback{min-height:1.1rem;color:var(--dsw-alias-state-error-primary,#c0392b);font-size:.75rem}.p6Z8Ea_actions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:.5rem;margin-left:auto;display:flex}.p6Z8Ea_planPicker{align-items:center;min-width:0;display:flex}";
		...
		var styles_module_css_default = {
			"actions": "p6Z8Ea_actions",
			"block": "p6Z8Ea_block",
			"blockTitle": "p6Z8Ea_blockTitle",
			"body": "p6Z8Ea_body",
			"card": "p6Z8Ea_card",
			"dot": "p6Z8Ea_dot",
			"error": "p6Z8Ea_error",
			"feedback": "p6Z8Ea_feedback",
			"footer": "p6Z8Ea_footer",
			"frame": "p6Z8Ea_frame",
			"hint": "p6Z8Ea_hint",
			"intro": "p6Z8Ea_intro",
			"mode": "p6Z8Ea_mode",
			"modeActive": "p6Z8Ea_modeActive",
			"modes": "p6Z8Ea_modes",
			"pickerWrap": "p6Z8Ea_pickerWrap",
			"planPicker": "p6Z8Ea_planPicker",
			"section": "p6Z8Ea_section",
			"strip": "p6Z8Ea_strip",
			"title": "p6Z8Ea_title",
			"titleIcon": "p6Z8Ea_titleIcon",
			"titleRow": "p6Z8Ea_titleRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\projects\dsh-model-switch\src\client\SubagentModelBadge.module.css.mjs
		const css$1 = ".YjczJG_badge{min-width:0;max-width:220px;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;border-radius:12px;align-items:center;padding:2px 8px;font-size:12px;font-weight:500;line-height:18px;display:inline-flex;overflow:hidden}";
		...
		var SubagentModelBadge_module_css_default = { "badge": "YjczJG_badge" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\projects\dsh-model-switch\src\client\SubagentCatalogAction.module.css.mjs
		const css = ".DeN42a_root{position:relative}.DeN42a_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.DeN42a_count{margin:0 5px}.DeN42a_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.DeN42a_trigger:hover,.DeN42a_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.DeN42a_trigger svg{transition:transform .12s}.DeN42a_triggerOpen{transform:rotate(180deg)}.DeN42a_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.DeN42a_node{min-width:0;position:relative}.DeN42a_menu>.DeN42a_node{margin-left:-3px}.DeN42a_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.DeN42a_row:hover>.DeN42a_clickarea,.DeN42a_row:focus-visible>.DeN42a_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.DeN42a_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.DeN42a_row>[data-state],.DeN42a_clickarea>[data-state]{margin-top:4px}.DeN42a_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.DeN42a_disabled:hover{background:0 0}.DeN42a_loadingRow{cursor:default}.DeN42a_disclosure,.DeN42a_disclosureSpace{flex:none;width:14px;height:18px}.DeN42a_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.DeN42a_disclosure:hover{color:var(--dsw-alias-label-primary)}.DeN42a_disclosureOpen{transform:rotate(90deg)}.DeN42a_content{flex-direction:column;flex:1;min-width:0;display:flex}.DeN42a_label,.DeN42a_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.DeN42a_label{color:inherit;font-weight:400}.DeN42a_summary,.DeN42a_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.DeN42a_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex-direction:column;flex:none;justify-content:center;align-items:flex-end;gap:0;min-width:0;max-width:148px;display:flex}.DeN42a_metricModel{max-width:100%;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;font-size:11px;font-weight:500;line-height:16px;overflow:hidden}.DeN42a_metricToken{line-height:18px}.DeN42a_metricDuration{line-height:16px}.DeN42a_children{margin-left:18px;padding-left:4px;position:relative}.DeN42a_children:before,.DeN42a_children>.DeN42a_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.DeN42a_children:before{height:26px;top:-26px}.DeN42a_children[aria-busy=true]:before{content:none}.DeN42a_children>.DeN42a_node:before{top:0;bottom:0;left:-4px}.DeN42a_children>.DeN42a_node:last-child:before{height:17px;bottom:auto}.DeN42a_children>.DeN42a_node>.DeN42a_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.DeN42a_notice,.DeN42a_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.DeN42a_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.DeN42a_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.DeN42a_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"activitySlot": "DeN42a_activitySlot",
			"children": "DeN42a_children",
			"clickarea": "DeN42a_clickarea",
			"content": "DeN42a_content",
			"count": "DeN42a_count",
			"disabled": "DeN42a_disabled",
			"disclosure": "DeN42a_disclosure",
			"disclosureOpen": "DeN42a_disclosureOpen",
			"disclosureSpace": "DeN42a_disclosureSpace",
			"error": "DeN42a_error",
			"label": "DeN42a_label",
			"loadingRow": "DeN42a_loadingRow",
			"menu": "DeN42a_menu",
			"metricDuration": "DeN42a_metricDuration",
			"metricModel": "DeN42a_metricModel",
			"metricToken": "DeN42a_metricToken",
			"metrics": "DeN42a_metrics",
			"node": "DeN42a_node",
			"notice": "DeN42a_notice",
			"refresh": "DeN42a_refresh",
			"root": "DeN42a_root",
			"row": "DeN42a_row",
			"summary": "DeN42a_summary",
			"trigger": "DeN42a_trigger",
			"triggerOpen": "DeN42a_triggerOpen"
		};
		//#endregion
